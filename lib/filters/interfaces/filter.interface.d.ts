...
export declare type ResourceFilter = string | number | Array<string> | object | RangeFilterInterface | StringFilterInterface | NumberFilterInterface | DateRangeFilterInterface;
